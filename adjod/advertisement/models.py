...
# class RecentlyviewLeads(models.Model):
#   """
#   Store every Leads viewed in the system.
#   """ 
#   lead = models.ForeignKey(Product, verbose_name='title')
#   system_id =  models.CharField(max_length=60, null=True, blank=True, help_text="auto generated by system for identifying system")
#   user = models.ForeignKey(UserProfile, null=True, help_text="Fixido user")
...
#   method =  models.CharField(max_length=20, null=True, blank=True, help_text="Call from webservice or API")
...
#   class Meta:
#     verbose_name = 'Recently view Lead'
#     verbose_name_plural = 'Recently view Leads'
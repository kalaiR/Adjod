...
class Product(models.Model):
    ...
    photos = models.ImageField(upload_to='products',null=True, max_length=500,help_text='Upload images jpeg and png format(2mb)',verbose_name='Photos for your ad')
    ...
    ad_brand=models.ForeignKey(Dropdown,null=True, related_name="ad_brand",help_text='Choose brand name',verbose_name='Brand')
    ad_year=models.CharField(max_length=10, null=True,help_text='Year of the product',verbose_name='Product Year')
    ...
    you_phone = models.CharField(validators=[phone_regex],max_length=15, null=True,help_text='Enter ad creater phone number or mobile number',verbose_name='Contact number')

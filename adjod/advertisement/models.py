...
class Product(models.Model):
    ...
    you_phone = models.CharField(validators=[phone_regex],max_length=12, null=True,help_text='Enter ad creater phone number or mobile number',verbose_name='Contact number')

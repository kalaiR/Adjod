...
class FixidoSearchBackend(ElasticsearchSearchBackend):
  ...
  def build_search_kwargs(self, *args, **kwargs):
    ...
    o = super(FixidoSearchBackend, self).build_search_kwargs(*args, **kwargs)
...
class FixidoSearchQuery(ElasticsearchSearchQuery):
...
class FixidoSearchEngine(ElasticsearchSearchEngine):
  backend = FixidoSearchBackend
  query = FixidoSearchQuery

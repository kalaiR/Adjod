...
--
-- Table structure for table `adjod_sitebanner`
--

DROP TABLE IF EXISTS `adjod_sitebanner`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `adjod_sitebanner` (
...
--
-- Dumping data for table `adjod_sitebanner`
--

LOCK TABLES `adjod_sitebanner` WRITE;
/*!40000 ALTER TABLE `adjod_sitebanner` DISABLE KEYS */;
INSERT INTO `adjod_sitebanner` VALUES (2,'static/banners/banner_bg_2.png','https://www.google.com',NULL,NULL),(3,'static/banners/hp_ad.png','https://www.gmail.com','/','bottom'),(4,'static/banners/background.png','https://www.google.com','/','bottom'),(5,'static/banners/quikr_logo.png','https://www.gmail.com','/','bottom');
/*!40000 ALTER TABLE `adjod_sitebanner` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `advertisement_freealert` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `productneed` varchar(50) NOT NULL,
  `locality_id` int(11) NOT NULL,
  `email` varchar(50) NOT NULL,
  `mobilenumber` varchar(50) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `advertisement_freealert_df6acbd9` (`locality_id`),
  CONSTRAINT `locality_id_refs_id_a1d5e44f` FOREIGN KEY (`locality_id`) REFERENCES `advertisement_locality` (`id`)
...
INSERT INTO `advertisement_freealert` VALUES (1,'nokia mobile',1,'kalaimca.gs@gmail.com','720300448'),(2,'nokia mobile',2,'kalaimca.gs@gmail,com','720300448'),(3,'nokia mobile',2,'kalaimca.gs@gmail,com','720300448'),(4,'nokia mobile',2,'kalaimca.gs@gmail,com','720300448'),(5,'nokia mobile',3,'kalaimca.gs@gmail,com','720300448'),(6,'nokia mobile',3,'kalaimca.gs@gmail,com','720300448'),(7,'nokia mobile',1,'kalaimca.gs@gmail,com','720300448'),(8,'nokia mobile',1,'kalaimca.gs@gmail,com','720300448'),(9,'asdfa',2,'kalaimca.gs@gmail,com','720300448'),(10,'asdfa',3,'kalaimca.gs@gmail,com','720300448'),(11,'nokia mobile',2,'kalaimca.gs@gmail,com','720300448'),(12,'kasdf',3,'kalaimca.gs@gmail,com','720300448'),(13,'kasdf',3,'kalaimca.gs@gmail,com','720300448'),(14,'sdgfsd',3,'kalaimca.gs@gmail,com','720300448'),(15,'nokia mobile',3,'kalaimca.gs@gmail,com','720300448');
...
INSERT INTO `advertisement_product` VALUES (1,NULL,2,8,'buy','gsdfg','static/img/photos/Screenshot from 2015-03-11 18:24:53.png','static/img/thumbs/Screenshot_from_2015-03-11_182453_thumbnail_21.png',1,'/static/videos/Funny Cute Baby Video - Talking Twin Babies.mp4','',342,3,'2012',2,5,'asafdasf','individual','kalai','kalai2@gmail.com','7200300448','2015-05-04','2015-05-04'),(2,NULL,2,8,'sell','fasdfasdf','static/img/photos/girl.jpg,static/img/photos/Screenshot from 2015-03-11 18:24:53.png','static/img/thumbs/girl_thumbnail_29.png,static/img/thumbs/Screenshot_from_2015-03-11_182453_thumbnail_22.png',2,'/static/videos/Funny Cute Baby Video - Talking Twin Babies.mp4','',343,3,'2000',2,5,'afasfd','individual','kk','kalaimca.gs@gmail.com','7200300448','2015-05-04','2015-05-04'),(3,NULL,1,1,'buy','sdfasdf','static/img/photos/cute-girl-2.png','static/img/thumbs/cute-girl-2_thumbnail_22.png',1,'/static/videos/Funny Cute Baby Video - Talking Twin Babies.mp4','',34342,1,'2012',2,5,'asfasfd','individual','kalai','kalaimca.gs@gmail.com','7200300448','2015-05-04','2015-05-04'),(4,NULL,1,1,'buy','sdfasdf','static/img/photos/cute-girl-2.png','static/img/thumbs/cute-girl-2_thumbnail_23.png',1,'/static/videos/Funny Cute Baby Video - Talking Twin Babies.mp4','',34342,1,'2012',2,5,'asfasfd','individual','kalai','kalaimca.gs@gmail.com','7200300448','2015-05-04','2015-05-04'),(5,NULL,1,1,'buy','sdfasdf','static/img/photos/cute-girl-2.png','static/img/thumbs/cute-girl-2_thumbnail_24.png',1,'/static/videos/Funny Cute Baby Video - Talking Twin Babies.mp4','',34342,1,'2012',2,5,'asfasfd','individual','kalai','kalaimca.gs@gmail.com','7200300448','2015-05-04','2015-05-04'),(6,NULL,1,1,'buy','sdfasdf','static/img/photos/cute-girl-2.png','static/img/thumbs/cute-girl-2_thumbnail_25.png',1,'/static/videos/Funny Cute Baby Video - Talking Twin Babies.mp4','',34342,1,'2012',2,5,'asfasfd','individual','kalai','kalaimca.g1@gmail.com','7200300448','2015-05-04','2015-05-04'),(7,NULL,1,1,'buy','sdfasdf','static/img/photos/cute-girl-2.png','static/img/thumbs/cute-girl-2_thumbnail_26.png',1,'http://www.youtube.com/watch?v=mnbY2jALfqI','',34342,1,'2012',2,5,'asfasfd','individual','kalai','kalaimca.g1@gmail.com','7200300448','2015-05-04','2015-05-04'),(8,NULL,1,1,'buy','sdfasdf','static/img/photos/cute-girl-2.png','static/img/thumbs/cute-girl-2_thumbnail_27.png',1,'http://www.youtube.com/watch?v=ljJw5BQTS4M','',34342,1,'2012',2,5,'asfasfd','individual','kalai','kalaimca.g2@gmail.com','7200300448','2015-05-04','2015-05-04'),(9,NULL,1,1,'buy','sdfasdf','static/img/photos/cute-girl-2.png','static/img/thumbs/cute-girl-2_thumbnail_28.png',1,'http://www.youtube.com/embed/W-Q7RMpINVo\"','',34342,1,'2012',2,5,'asfasfd','individual','kalai','kalaimca.g2@gmail.com','7200300448','2015-05-04','2015-05-04'),(10,NULL,2,8,'buy','asdf','static/img/photos/Screenshot from 2015-03-11 18:24:53.png','static/img/thumbs/Screenshot_from_2015-03-11_182453_thumbnail_23.png',1,'http://www.youtube.com/embed/XGSy3_Czz8k','',342,3,'2012',2,5,'adfasdf','individual','kalai','asdfasd@gmail.com','7200300448','2015-05-04','2015-05-04');
...
--
-- Table structure for table `adworks_attribute`
--

DROP TABLE IF EXISTS `adworks_attribute`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `adworks_attribute` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `adworks_attribute`
--

LOCK TABLES `adworks_attribute` WRITE;
/*!40000 ALTER TABLE `adworks_attribute` DISABLE KEYS */;
INSERT INTO `adworks_attribute` VALUES (1,'banner1','banner1 for google.com');
/*!40000 ALTER TABLE `adworks_attribute` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `adworks_banner`
--

DROP TABLE IF EXISTS `adworks_banner`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `adworks_banner` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `campaign_id` int(11) NOT NULL,
  `dimension_id` int(11) NOT NULL,
  `attribute_id` int(11) NOT NULL,
  `clicktag` varchar(200) NOT NULL,
  `description` longtext NOT NULL,
  `token` char(32) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `token` (`token`),
  KEY `adworks_banner_8fd46b1a` (`campaign_id`),
  KEY `adworks_banner_de978db5` (`dimension_id`),
  KEY `adworks_banner_f2eca69f` (`attribute_id`),
  CONSTRAINT `attribute_id_refs_id_8b61fdc8` FOREIGN KEY (`attribute_id`) REFERENCES `adworks_attribute` (`id`),
  CONSTRAINT `campaign_id_refs_id_7f35d3c3` FOREIGN KEY (`campaign_id`) REFERENCES `adworks_campaign` (`id`),
  CONSTRAINT `dimension_id_refs_id_a62b7ef4` FOREIGN KEY (`dimension_id`) REFERENCES `adworks_dimension` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `adworks_banner`
--

LOCK TABLES `adworks_banner` WRITE;
/*!40000 ALTER TABLE `adworks_banner` DISABLE KEYS */;
INSERT INTO `adworks_banner` VALUES (1,1,1,1,'','banner1 for google.com','57eb0699ef7f42cb95754e7bec633347');
/*!40000 ALTER TABLE `adworks_banner` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `adworks_campaign`
--

DROP TABLE IF EXISTS `adworks_campaign`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `adworks_campaign` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `token` (`token`),
  KEY `adworks_campaign_4a4e8ffb` (`client_id`),
  CONSTRAINT `client_id_refs_id_e350d84` FOREIGN KEY (`client_id`) REFERENCES `adworks_client` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `adworks_campaign`
--

LOCK TABLES `adworks_campaign` WRITE;
/*!40000 ALTER TABLE `adworks_campaign` DISABLE KEYS */;
INSERT INTO `adworks_campaign` VALUES (1,1,'banner1','banner1','http://www.google.com','adworks/campaign/girl.jpg','1bf0a6c6fb3a417a9af4ae69b7f59b7b');
/*!40000 ALTER TABLE `adworks_campaign` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `adworks_client`
--

DROP TABLE IF EXISTS `adworks_client`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `adworks_client` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(100) NOT NULL,
  `slug` varchar(100) NOT NULL,
...
--
-- Dumping data for table `adworks_client`
--

LOCK TABLES `adworks_client` WRITE;
/*!40000 ALTER TABLE `adworks_client` DISABLE KEYS */;
INSERT INTO `adworks_client` VALUES (1,'banner1','banner1','http://www.google.com','http://www.google.com','adworks/client/Screenshot_from_2015-03-11_18_24_53.png','ccbc62bdeacb4e77900e70ff58ebe951');
/*!40000 ALTER TABLE `adworks_client` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `adworks_dimension`
--

DROP TABLE IF EXISTS `adworks_dimension`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `adworks_dimension` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `adworks_dimension`
--

LOCK TABLES `adworks_dimension` WRITE;
/*!40000 ALTER TABLE `adworks_dimension` DISABLE KEYS */;
INSERT INTO `adworks_dimension` VALUES (1,500,200,'banner1');
/*!40000 ALTER TABLE `adworks_dimension` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `adworks_version`
--

DROP TABLE IF EXISTS `adworks_version`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `adworks_version` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `adworks_version_50ab1ff4` (`banner_id`),
  CONSTRAINT `banner_id_refs_id_b10ae0f8` FOREIGN KEY (`banner_id`) REFERENCES `adworks_banner` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `adworks_version`
--

LOCK TABLES `adworks_version` WRITE;
/*!40000 ALTER TABLE `adworks_version` DISABLE KEYS */;
INSERT INTO `adworks_version` VALUES (1,1,1,'banner1 for google.com','adworks/version/cute-girl-2.png','','2015-05-05 11:04:54');
/*!40000 ALTER TABLE `adworks_version` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-05-09 12:48:16
